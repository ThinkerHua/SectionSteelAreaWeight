...
GBSectionSteel const GBSecSte_HT[] = {
	{"100*50",{95,48,3.2,4.5},5.98,0.362,},
...
GBSectionSteel const GBSecSte_C[] = {
	{"60*30*10*2.5",{60,30,10,2.5},2.363,0,},
...
GBSectionSteel const GBSecSte_Z[] = {
	{"100*40*20*2.0",{100,40,20,2},3.208,0,},
...
int link_pGBSecSte(GBSectionSteel const **p, char const *SecSteType) {
	if (strcmp(SecSteType, "H") == 0) {
		...
		*p = GBSecSte_HT;
		return sizeof(GBSecSte_HT) / sizeof(GBSecSte_HT[0]);
	} else if (strcmp(SecSteType, "T") == 0) {
		*p = GBSecSte_T;
		return sizeof(GBSecSte_T) / sizeof(GBSecSte_T[0]);
		...
		*p = GBSecSte_Z;
		return sizeof(GBSecSte_Z) / sizeof(GBSecSte_Z[0]);
	} else {
		*p = NULL;
		return -1;
	}
